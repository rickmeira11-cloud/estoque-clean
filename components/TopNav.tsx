...
const NAV = [
  ...
  { href:'/mural', label:'Ministerios', icon:'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75M9 7a4 4 0 110 8 4 4 0 010-8z' },
...
const NAV_ADMIN = [
  { href:'/ministerios', label:'Ministerios', icon:'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75M9 7a4 4 0 110 8 4 4 0 010-8z' },
...
export function TopNav() {
  ...
  useEffect(() => { setMenuOpen(false); setAlertOpen(false) }, [pathname])
        ...
        <div style={{display:'flex',alignItems:'center',gap:'2px',flex:1}} className="desktop-nav">
          ...
          {isAdmin && (
            <>
              ...
              {NAV_ADMIN.map(n => <NavLink key={n.href} {...n} small isActive={active(n.href)}/>)}
            </>
          )}
        </div>
        ...
        <div style={{display:'flex',alignItems:'center',gap:'8px',marginLeft:'auto',flexShrink:0}} className="desktop-nav">
          ...
          <div ref={alertRef} style={{position:'relative'}}>
            <button onClick={() => setAlertOpen(o => !o)} style={{
              ...
              background: alertOpen ? 'var(--bg-3)' : 'transparent',
            ...
            {alertOpen && (
              <div className="slide-down" style={{position:'absolute',top:'calc(100% + 8px)',right:0,background:'var(--bg-2)',border:'1px solid var(--border-md)',borderRadius:'var(--radius)',minWidth:'280px',maxWidth:'320px',overflow:'hidden',zIndex:100}}>
                ...
                <div style={{padding:'10px 14px',borderTop:'1px solid var(--border)'}}>
                  <Link href="/relatorios" style={{fontSize:'12px',color:'var(--brand-light)',textDecoration:'none',display:'flex',alignItems:'center',gap:'4px'}}
